...
public class Server {
    public static void main(String[] args)throws Exception {
         ...
         */
        String s = UUID.randomUUID().toString(); //  生成一个随机字符串作为文件名的一部分
        String name = s + System.currentTimeMillis(); //  生成一个随机字符串作为文件名的一部分

        //4.创建FileOutputStream,将读取过来的图片写到硬盘上
        FileOutputStream fos = new FileOutputStream("D:\\1\\java\\src\\main\\java\\案例1\\"+name+".png");
        //5.边读边写
